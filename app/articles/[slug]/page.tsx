  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FAF4EC' }}>
      <div className="max-w-3xl mx-auto px-4 pt-8">
        <Link href="/articles" className="inline-flex items-center gap-2 text-sm font-medium hover:opacity-70" style={{ color: '#7D9B76' }}>
          ← Back to Articles
        </Link>
      </div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-16">
        ...
        <footer className="mt-12 pt-8 border-t" style={{ borderColor: '#e8ddd0' }}>
          <Link href="/articles" className="font-medium hover:opacity-80" style={{ color: '#7D9B76' }}>
