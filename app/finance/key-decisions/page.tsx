export default function KeyDecisions() {
  const decisions = [
    ...
    },
    {
      ...
      theMath: "Many retirees draw down taxable and Roth accounts first, leaving pre-tax accounts to grow — which triggers massive RMDs at 73 (or 75 if you were born in 1960 or later, under SECURE 2.0) that push them into higher brackets. A better strategy often involves Roth conversions between retirement and your RMD start date, when income may be lower.",
