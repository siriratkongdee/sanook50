export default function Finance() {
  const articles = [
    ...
    { title: "Investing in Your 50s: Different Rules Apply", excerpt: "The risk/reward calculus changes after 50. Here's how to think about growth vs. protection.", emoji: "📊", tag: "Investing" },
    ...
    { title: "Social Security for Women: Getting the Most From Your Benefits", excerpt: "Timing your Social Security claim can mean the difference of hundreds of dollars a month.", emoji: "📋", tag: "Social Security" },
  ];
