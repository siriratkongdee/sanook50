export default function Career() {
  const articles = [
    ...
    { title: "Negotiating Salary After 50: Yes, You Can and Should", excerpt: "Age bias is real but so is your leverage. Here's how to negotiate confidently at every stage.", emoji: "💼", tag: "Negotiation" },
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FAF4EC' }}>
      <div className="py-16" style={{ backgroundColor: '#FAF4EC', borderBottom: '4px solid #C4622D' }}>
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto" style={{ color: '#C4622D' }}>Rediscover what you're capable of — on your own terms.</p>
        </div>
      </div>
